...
that was founded in 2008, but really took off as early as 2014. You can [get installation steps here](https://docs.docker.com/get-docker/) or read the [getting started guide](https://docs.docker.com/get-started/). 
To understand Docker, we should probably start with the basics of containers,
and a little history around them.

## Containers

A container is generally an encapsulated environment that is created from one or more binaries (images) to provide some form of isolation. Read more about [containers here](container-images.md).
...
To give you a good understanding of OCI projects, you can read more about the goals of [OCI projects](oci-projects.md). 
...
to reference the containers. Read more about [Content Addressability](digests.md) here.
...
offers an entire new space of challenges. Read about [distributing container images here](distribution.md)
